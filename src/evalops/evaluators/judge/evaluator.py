...
class LLMJudgeEvaluator:
    ...
    def config(self) -> dict[str, Any]:
        return {
            ...
            "model_digest": getattr(self.provider, "model_digest", None),
            "quantization": getattr(self.provider, "quantization", None),
            "parameter_size": getattr(self.provider, "parameter_size", None),
            "context_length": getattr(self.provider, "context_length", None),
